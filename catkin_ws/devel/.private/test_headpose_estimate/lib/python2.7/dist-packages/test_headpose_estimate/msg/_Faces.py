...
"""autogenerated by genpy from test_headpose_estimate/Faces.msg. Do not edit."""
import sys
...
import test_headpose_estimate.msg
import std_msgs.msg

class Faces(genpy.Message):
  _md5sum = "9efd106cd1ef1598e44e5a94142562d9"
  _type = "test_headpose_estimate/Faces"
...
"""
  __slots__ = ['faces']
  _slot_types = ['test_headpose_estimate/Face[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = test_headpose_estimate.msg.Face()
        _v8 = val1.header
        start = end
        end += 4
