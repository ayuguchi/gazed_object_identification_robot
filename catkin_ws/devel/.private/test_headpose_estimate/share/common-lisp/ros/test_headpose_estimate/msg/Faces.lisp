...
(cl:defclass <Faces> (roslisp-msg-protocol:ros-message)
  ((faces
    :reader faces
    :initarg :faces
    :type (cl:vector test_headpose_estimate-msg:Face)
   :initform (cl:make-array 0 :element-type 'test_headpose_estimate-msg:Face :initial-element (cl:make-instance 'test_headpose_estimate-msg:Face))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Faces>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Faces)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_headpose_estimate-msg:<Faces> is deprecated: use test_headpose_estimate-msg:Faces instead.")))

(cl:ensure-generic-function 'faces-val :lambda-list '(m))
(cl:defmethod faces-val ((m <Faces>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_headpose_estimate-msg:faces-val is deprecated.  Use test_headpose_estimate-msg:faces instead.")
  (faces m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Faces>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'faces)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'test_headpose_estimate-msg:Face))
