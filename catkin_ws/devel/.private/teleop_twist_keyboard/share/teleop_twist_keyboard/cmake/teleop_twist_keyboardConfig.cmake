...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /root/catkin_ws/src/teleop_twist_keyboard)
  set(teleop_twist_keyboard_DEVEL_PREFIX /root/catkin_ws/devel/.private/teleop_twist_keyboard)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/teleop_twist_keyboard/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/teleop_twist_keyboard/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
