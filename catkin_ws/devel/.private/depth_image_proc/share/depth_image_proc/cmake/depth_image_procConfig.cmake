...
if("TRUE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /root/catkin_ws/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /root/catkin_ws/devel/.private/depth_image_proc)
  ...
  set(depth_image_proc_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/src/image_pipeline/depth_image_proc/include " STREQUAL " ")
  set(depth_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/src/image_pipeline/depth_image_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/image_pipeline/depth_image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/depth_image_proc/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
