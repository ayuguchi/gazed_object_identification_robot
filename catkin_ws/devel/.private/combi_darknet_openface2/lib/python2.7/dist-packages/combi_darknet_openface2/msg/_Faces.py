...
"""autogenerated by genpy from combi_darknet_openface2/Faces.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import combi_darknet_openface2.msg
import geometry_msgs.msg
import std_msgs.msg

class Faces(genpy.Message):
  _md5sum = "9efd106cd1ef1598e44e5a94142562d9"
  _type = "combi_darknet_openface2/Faces"
...
"""
  __slots__ = ['faces']
  _slot_types = ['combi_darknet_openface2/Face[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = combi_darknet_openface2.msg.Face()
        _v8 = val1.header
        start = end
        end += 4
