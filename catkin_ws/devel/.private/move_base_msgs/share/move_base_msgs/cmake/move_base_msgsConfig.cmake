...
if("TRUE" STREQUAL "TRUE")
  set(move_base_msgs_SOURCE_PREFIX /root/catkin_ws/src/navigation/move_base_msgs)
  set(move_base_msgs_DEVEL_PREFIX /root/catkin_ws/devel/.private/move_base_msgs)
...
if(NOT "/root/catkin_ws/devel/.private/move_base_msgs/include " STREQUAL " ")
  set(move_base_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/move_base_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/navigation/move_base_msgs/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/move_base_msgs/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
