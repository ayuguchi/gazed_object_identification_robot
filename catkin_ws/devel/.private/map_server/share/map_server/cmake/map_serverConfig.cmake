...
if("TRUE" STREQUAL "TRUE")
  ...
  set(map_server_DEVEL_PREFIX /root/catkin_ws/devel/.private/map_server)
...
if(NOT "/root/catkin_ws/src/navigation/map_server/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/navigation/map_server/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/map_server/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
