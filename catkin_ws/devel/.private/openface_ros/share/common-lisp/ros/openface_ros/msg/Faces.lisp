...
(cl:defclass <Faces> (roslisp-msg-protocol:ros-message)
  ((faces
    :reader faces
    :initarg :faces
    :type (cl:vector openface_ros-msg:Face)
   :initform (cl:make-array 0 :element-type 'openface_ros-msg:Face :initial-element (cl:make-instance 'openface_ros-msg:Face))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Faces>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Faces)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openface_ros-msg:<Faces> is deprecated: use openface_ros-msg:Faces instead.")))

(cl:ensure-generic-function 'faces-val :lambda-list '(m))
(cl:defmethod faces-val ((m <Faces>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openface_ros-msg:faces-val is deprecated.  Use openface_ros-msg:faces instead.")
  (faces m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Faces>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'faces)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'openface_ros-msg:Face))
