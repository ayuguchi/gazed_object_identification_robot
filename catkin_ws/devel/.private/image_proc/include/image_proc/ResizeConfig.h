...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ResizeConfig::AbstractParamDescriptionConstPtr(new ResizeConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum_description': 'interpolation type', 'enum': [{'srcline': 11, 'description': 'Nearest neighbor', 'srcfile': '/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'INTER_NEAREST'}, {'srcline': 12, 'description': 'Linear', 'srcfile': '/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'INTER_LINEAR'}, {'srcline': 13, 'description': 'Cubic', 'srcfile': '/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'INTER_CUBIC'}, {'srcline': 14, 'description': 'Lanczos4', 'srcfile': '/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'INTER_LANCZOS4'}]}", &ResizeConfig::interpolation)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_INTER_NEAREST = 0;
//#line 12 "/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_INTER_LINEAR = 1;
//#line 13 "/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_INTER_CUBIC = 2;
//#line 14 "/root/catkin_ws/src/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_INTER_LANCZOS4 = 4;
}
