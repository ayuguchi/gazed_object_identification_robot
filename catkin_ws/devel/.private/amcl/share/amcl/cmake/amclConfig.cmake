...
if("TRUE" STREQUAL "TRUE")
  ...
  set(amcl_DEVEL_PREFIX /root/catkin_ws/devel/.private/amcl)
...
if(NOT "/root/catkin_ws/devel/.private/amcl/include;/root/catkin_ws/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/amcl/include;/root/catkin_ws/src/navigation/amcl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/navigation/amcl/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/amcl/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
