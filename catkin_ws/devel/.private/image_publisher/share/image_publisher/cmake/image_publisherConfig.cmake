...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /root/catkin_ws/src/image_pipeline/image_publisher)
  set(image_publisher_DEVEL_PREFIX /root/catkin_ws/devel/.private/image_publisher)
  ...
  set(image_publisher_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/.private/image_publisher/include " STREQUAL " ")
  set(image_publisher_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/image_publisher/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/image_pipeline/image_publisher/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/image_publisher/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
