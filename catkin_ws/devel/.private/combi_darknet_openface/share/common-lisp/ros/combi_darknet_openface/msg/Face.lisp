...
(cl:defmethod cl:initialize-instance :after ((m <Face>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Face)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name combi_darknet_openface-msg:<Face> is deprecated: use combi_darknet_openface-msg:Face instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:header-val is deprecated.  Use combi_darknet_openface-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'left_gaze-val :lambda-list '(m))
(cl:defmethod left_gaze-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:left_gaze-val is deprecated.  Use combi_darknet_openface-msg:left_gaze instead.")
  (left_gaze m))

(cl:ensure-generic-function 'right_gaze-val :lambda-list '(m))
(cl:defmethod right_gaze-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:right_gaze-val is deprecated.  Use combi_darknet_openface-msg:right_gaze instead.")
  (right_gaze m))

(cl:ensure-generic-function 'head_pose-val :lambda-list '(m))
(cl:defmethod head_pose-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:head_pose-val is deprecated.  Use combi_darknet_openface-msg:head_pose instead.")
  (head_pose m))

(cl:ensure-generic-function 'landmarks_3d-val :lambda-list '(m))
(cl:defmethod landmarks_3d-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:landmarks_3d-val is deprecated.  Use combi_darknet_openface-msg:landmarks_3d instead.")
  (landmarks_3d m))

(cl:ensure-generic-function 'landmarks_2d-val :lambda-list '(m))
(cl:defmethod landmarks_2d-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:landmarks_2d-val is deprecated.  Use combi_darknet_openface-msg:landmarks_2d instead.")
  (landmarks_2d m))
