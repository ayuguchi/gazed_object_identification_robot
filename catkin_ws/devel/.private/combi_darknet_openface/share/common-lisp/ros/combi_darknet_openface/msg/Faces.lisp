...
(cl:defclass <Faces> (roslisp-msg-protocol:ros-message)
  ((faces
    :reader faces
    :initarg :faces
    :type (cl:vector combi_darknet_openface-msg:Face)
   :initform (cl:make-array 0 :element-type 'combi_darknet_openface-msg:Face :initial-element (cl:make-instance 'combi_darknet_openface-msg:Face))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Faces>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Faces)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name combi_darknet_openface-msg:<Faces> is deprecated: use combi_darknet_openface-msg:Faces instead.")))

(cl:ensure-generic-function 'faces-val :lambda-list '(m))
(cl:defmethod faces-val ((m <Faces>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader combi_darknet_openface-msg:faces-val is deprecated.  Use combi_darknet_openface-msg:faces instead.")
  (faces m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Faces>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'faces)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'combi_darknet_openface-msg:Face))
