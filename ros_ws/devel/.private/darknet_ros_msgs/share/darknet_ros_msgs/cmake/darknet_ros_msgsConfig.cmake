...
if("TRUE" STREQUAL "TRUE")
  set(darknet_ros_msgs_SOURCE_PREFIX /root/catkin_ws/src/darknet_ros/darknet_ros_msgs)
  set(darknet_ros_msgs_DEVEL_PREFIX /root/catkin_ws/devel/.private/darknet_ros_msgs)
...
if(NOT "/root/catkin_ws/devel/.private/darknet_ros_msgs/include " STREQUAL " ")
  set(darknet_ros_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/.private/darknet_ros_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'darknet_ros_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Marko Bjelonic <marko.bjelonic@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'darknet_ros_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/darknet_ros/darknet_ros_msgs/${idir}'.  Ask the maintainer 'Marko Bjelonic <marko.bjelonic@mavt.ethz.ch>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/darknet_ros_msgs/lib;/root/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
