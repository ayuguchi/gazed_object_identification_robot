...
struct BoundingBoxes_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >::other >  _boundingBoxes_type;
...
struct MD5Sum< ::darknet_ros_msgs::BoundingBoxes_<ContainerAllocator> >
{
  ...
  {
    return "ea71eb1791dc15f22ef61ff50be3c0f1";
  }

  static const char* value(const ::darknet_ros_msgs::BoundingBoxes_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xea71eb1791dc15f2ULL;
  static const uint64_t static_value2 = 0x2ef61ff50be3c0f1ULL;
};
...
struct Printer< ::darknet_ros_msgs::BoundingBoxes_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::darknet_ros_msgs::BoundingBoxes_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.boundingBoxes.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >::stream(s, indent + "    ", v.boundingBoxes[i]);
    }
  }
};
